...
def grab_screen(region=None):
    #https://www.programcreek.com/python/example/62809/win32ui.CreateBitmapimporttimeimportwin32apiimportwin32conimportwin32guiimportwin32uidefget_de
    # get hollow knight hwnd
    hwnd = win32gui.FindWindow('Hollow Knight', None)
    ...
    #memdc.BitBlt((0, 0), (width, right), srcdc, (left, top), win32con.SRCCOPY)
...
def key_check():
    operations = []
    if win32api.GetAsyncKeyState(0x49):
        operations.append("A")
